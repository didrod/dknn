...
namespace dknn {
  ...
  using feature_knn_query_result_info_t =
    std::tuple<feature_distance_t, feature_class_t>;

  using knn_query_result_t =
    std::map<feature_id_t, feature_knn_query_result_info_t>;
